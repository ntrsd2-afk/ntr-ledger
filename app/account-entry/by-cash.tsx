...
export default function ByCashScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>By Cash Entries</Text>
        <View style={{ width: 56 }} />
      </View>
      <View style={styles.totalBox}>
        <Text style={styles.totalLabel}>Total By Cash</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.empty}>No By Cash entries.</Text>}
