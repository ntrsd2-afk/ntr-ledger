...
export default function ToCashScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>To Cash Entries</Text>
        <View style={{ width: 56 }} />
      </View>
      <View style={styles.totalBox}>
        <Text style={styles.totalLabel}>Total To Cash</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.empty}>No To Cash entries.</Text>}
